...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconstant_v1_1_5 -L blk_mem_gen_v8_4_2 -L xlslice_v1_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="E:/VIVADO/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
